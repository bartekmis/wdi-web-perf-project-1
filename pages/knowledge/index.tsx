...
import { getAllCategories } from '@/queries/knowledge';
...
const KnowledgeArticles = ({
  ...
  return (
    <>
                ...
                <div className='grid md:grid-cols-3 gap-9 md:gap-12 xl:gap-y-16'>
                  {featuredArticle && (
                    <Link
                      ...
                      className='group relative bg-white flex flex-col md:flex-row md:col-[1/4] p-0 md:p-6'
                    >
      ...
      <PerformanceMonitor pageType="SSR" />
    </>
  );
};
