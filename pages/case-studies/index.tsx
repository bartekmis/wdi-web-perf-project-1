...
import { getAllCategories } from '@/queries/case-studies';
...
const CaseStudies = ({
  ...
  return (
    <>
                ...
                <div className='grid md:grid-cols-2 gap-9 md:gap-12 xl:gap-y-16'>
                  {featuredCaseStudy && (
                      <Link
                        ...
                        className='group relative bg-white flex flex-col md:flex-row md:col-[1/3]'
                      >
                        <Decoration
                          type={1}
                          colour={0}
                        ...
                        <div className='relative md:w-[calc(40%+24px)] p-9 md:px-12 xl:pt-20'>
                          ...
                          <Decoration
                            ...
                            colour={1}
                            variant='custom'
                            className='right-0 md:right-[36px] bottom-0 w-[42%] !h-[30%] !bg-cover'
                          />
                        </div>
      ...
      <PerformanceMonitor pageType="ISR" />
    </>
  );
};
