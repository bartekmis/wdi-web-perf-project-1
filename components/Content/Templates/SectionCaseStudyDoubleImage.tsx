...
const SectionCaseStudyDoubleImage = ({ data }: { data: any }) => {
          ...
          {!!data.images.length &&
            data.images.map((item: any, index: number) => {
              return (
                ...
                >
                  <figure
                    className={`w-full flex flex-col items-start animation-revealFromCircle ${
...
export default SectionCaseStudyDoubleImage;
